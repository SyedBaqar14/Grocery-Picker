    ...
    return Scaffold(
      body: BlocBuilder<PickListCubit, PickListState>(
          builder: (context, state) {
            if (state.searchingFinishOrder == "searching") {
              return Center(
              ...
              return ListView.separated(
                ...
                itemCount: state.queryResultFinishOrder!
                  ...
                  return Slidable(
                    // Specify a key if the Slidable is dismissible.
                        ...
                        children: [
                          SlidableAction(
                            ...
                            onPressed: (context) => details(
                                context: context,
                                orderID:
                                state.queryResultFinishOrder!.data!['listOrdersFilters']
                                ['orders'][index]['id']),
                          ...
                          // SlidableAction(
                          //   flex: 2,
                          //   onPressed: (context) => unHold(context: context, statusID: 1, orderID: state.queryResultFinishOrder!.data!['listOrdersFilters']['orders'][index]['id']),
                      ...
                      child: ListTile(contentPadding: EdgeInsets.only(left: 8),
                        title: Text("Order ID: ${state.queryResultFinishOrder!
...
//     await packOrderCubit.getOrders(userID: 9, orderStatusID: 14);
//   });
// }
